...
if($predict=="1"){$predict="暗戀";}
else if($predict=="2"){$predict="甜蜜";}
else if($predict=="3"){$predict="抱怨";}
else if($predict=="4"){$predict="失戀";}

echo json_encode($predict,JSON_UNESCAPED_UNICODE)
?>